...
Si no hay grabación activa, haz git pull en este proyecto (TeamsRecorder) y muestra un resumen de los cambios descargados. Si ya estaba al día, indícalo claramente.
